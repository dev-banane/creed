...
export const tabAutocomplete: Article = {
  ...
  description:
    "Press Tab while editing your Creedom and it finishes the thought in your voice, drawn from your whole file. How it works, what it costs, and why it gets sharper as your file does.",
  cluster: "category",
  datePublished: "2026-07-12",
  dateModified: "2026-07-12",
  lead:
    "Tab is Creedom's in-editor autocomplete. Put your cursor anywhere in a section, press Tab once, and a suggestion streams in as ghost text: the rest of the sentence, written in your voice, drawn from everything else in your file. Press Tab again to accept it, press Escape to dismiss it, or just keep typing and it gets out of your way.\n\nIt is not the per-keystroke prediction you know from code editors. Tab only runs when you ask, it completes one thought at a time, and it never invents facts about you. It can only recombine and extend what is already in your file or clearly implied by what you just typed. If it does not know your deploy tooling, it writes up to the gap and stops rather than guessing.\n\nThat design means Tab compounds. With one thin section, it can only offer structure. With a full file, it completes a Preferences line with your actual tools, your actual constraints, your actual people, because it read them in your other sections. The sharper your Creedom, the sharper Tab writes.",
  body: [
    { type: "h2", text: "How it works" },
    {
      type: "p",
      text: "Every press sends your whole visible Creedom plus the text around your cursor to a fast model, with one standing instruction set: match your voice and formatting, be specific, and never invent a fact that is not in the file. The suggestion streams back as tinted ghost text at your cursor, usually in well under a second.",
    },
    {
      type: "ul",
      items: [
    ...
    {
      type: "p",
      text: "Ghost text is never document content. It lives outside your file until you accept it, so a dismissed suggestion leaves no trace in your Creedom, your history, or your agents' reads.",
    },
    { type: "h2", text: "It gets better as your file does" },
    {
      type: "p",
      text: "Most autocomplete predicts from the last few lines. Tab conditions on your entire Creedom, so its ceiling is set by how much true, specific context you have written. That inverts the usual curve: instead of being impressive on day one and flat after, Tab starts modest and compounds. Writing good context makes writing more good context easier.",
    },
    {
      type: "p",
      text: "It also holds itself to the same bar Creedom's quality analysis scores you on: specific, anchored, steering, current, tight. A completion that pads or flatters would be worse than none, so Tab is instructed to write lines an AI would actually act on.",
    },
  ...
  faq: [
    {
      question: "How do I use Tab in Creedom?",
      answer:
    ...
    {
      question: "Why is Tab better when my Creedom is fuller?",
      answer:
