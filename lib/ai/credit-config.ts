...
// annual lump); lifetime is a one-time $20 grant that never resets.
...
// the grant path (lib/ai/credits) stays in step with whatever provisions a
// company Creed's initial grant.
